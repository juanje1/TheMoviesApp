...
fun lastName(registerViewModel: RegisterViewModel): String {
    ...
    if (isEdited) {
        isEdited = false
        registerViewModel.checkEmptyField(context.getString(R.string.register_last_name_error_messages), lastNameText)
    }
    ...
    OutlinedTextField(
        ...
        trailingIcon = {
            if (stateRegister.errorMessages[context.getString(R.string.register_last_name_error_messages)]?.isNotEmpty() == true)
                Icon(
                    imageVector = Icons.Filled.Error,
                    contentDescription = context.getString(R.string.register_last_name_error_field_description),
                    tint = MaterialTheme.colorScheme.error
                )
        },
        isError = stateRegister.errorMessages[context.getString(R.string.register_last_name_error_messages)]?.isNotEmpty() == true
    )
    if (stateRegister.errorMessages[context.getString(R.string.register_last_name_error_messages)]?.isNotEmpty() == true) {
        Text(
            text = stateRegister.errorMessages[context.getString(R.string.register_last_name_error_messages)] ?: "",
